...
func TestTypedRequestStructsMatchCatalog(t *testing.T) {
	...
	bindings := []struct {
		...
		{"claude.modelList", reflect.TypeOf(claudeModelListParams{})},
		{"claude.setModel", reflect.TypeOf(claudeSetModelParams{})},
		...
		{"cursor.modelList", reflect.TypeOf(cursorModelListParams{})},
		{"cursor.setModel", reflect.TypeOf(cursorSetModelParams{})},
